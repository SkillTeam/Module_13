const tasks = `
    ...
    [
        ...
        },
        {
            ...
            "answer4": { "result": true, "value": "опускается, охлаждается, становиться суше" }
        },
        {
        ...
        {
            "question": "По территории каких субъектов проходит нефтепровод  «Восточная Сибирь – Тихий океан»?",
            "answer1": { "result": false, "value": "Республика Бурятия, Хабаровский край, Приморский край, Иркутская область, Амурская область, Чукотский автономный округ" },
            "answer2": { "result": true, "value": "Республика Саха (Якутия), Приморский край, Хабаровский край, Иркутская область, Амурская область, Еврейская автономная область" },
            "answer3": { "result": false, "value": "Хабаровский край, Республика Бурятия, Иркутская область, Амурская область, Магаданская область" },
            "answer4": { "result": false, "value": "Республика Тыва, Республика Саха (Якутия), Приморский край, Иркутская область, Еврейская автономная область" }
        },
        {
