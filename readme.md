...
Адександра, ссылка на на гитхаб-профиль: https://github.com/sanechkae
Фаиль Яруллин, ссылка на на гитхаб-профиль: https://github.com/fg-yarullin
Писание и возможноти игры:
Список заданий состоит из более 30 вопросов из области географии. Созда список вопросов на определенную тематику (количество необходимых верных 19).
Когда только начинается ход игрока, ему дается три секунды на подготовку - демонстрируется обратный отсчёт "3..2..1".
Перед началом игры имеется возможность изменить количество игроков (по умолчанию 1 игрок).
Доработано оформление игры.
При запсуке игры сперва появляется описание игры.
Реализовы кнопика "Старт игры".
Реализовы кнопика "Конец игры", которая завершает игру проигрышем.
Имеется возможность изменения количества времени на игру перед игрой.
